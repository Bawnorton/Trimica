...
abstract class ReloadableServerResourcesMixin {
	...
	private static ReloadableServerResources captureUnloadedTags(ReloadableServerResources original) {
		UnloadedTagHolder.setUnloadedTags(((ReloadableServerResourcesAccessor) original).trimica$postponedTags());
		return original;
	}
}
